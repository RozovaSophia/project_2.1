...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ["Перевод организации", "Перевод со счета на счет", "Перевод организации"],
        ),
        (
            [
                {
...
def test_transaction_random_descriptions(universal_fixture) -> None:
...
def test_atypical_card_number_generator(universal_fixture) -> None:
